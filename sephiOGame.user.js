...
if (gup('sephiScript') == '1') {
    ...
    sephi_frigos_data+='<table style="text-align:left;color:#808080;position:relative;top:-7px;left:23px;padding-left:40px;font-weight:normal;"><tr><td><select id="time_no_AA_eject_choice" style="position:relative;top:-1px;visibility: visible;color: #000;background-color: #b3c3cb;border: 1px solid #668599;height:18px;"/><option value="1" '+((readCookie('time_no_AA_with_eject','AA') == 'oui')?'selected':'')+'>Avec</option><option value="0" '+((readCookie('time_no_AA_with_eject','AA') == 'non' || readCookie('time_no_AA_with_eject','AA') == null)?'selected':'')+'>Sans</option></select> éjection auto&nbsp;</td><td><select id="time_no_AA_with_eject" style="display: '+((readCookie('time_no_AA_with_eject','AA') == 'oui')?'block':'none')+';visibility: visible;color: #000;background-color: #b3c3cb;border: 1px solid #668599;height:18px;"/><option value="transport" '+((readCookie('time_no_AA_type_eject','AA') == '') ? 'selected':'')+'>par défaut (transport)</option><option value="transport" '+(readCookie('time_no_AA_type_eject','AA') == 'transport' ? 'selected':'')+'>par transport entre planete (visible)</option><option value="exped" '+(readCookie('time_no_AA_type_eject','AA') == 'exped' ? 'selected':'')+'>par une expedition (ghosted)</option><option value="recyclers" '+(readCookie('time_no_AA_type_eject','AA') == 'recyclers' ? 'selected':'')+'>par le recyclage (ghosted)</option></select></td><td>&nbsp;<i><span id="save_time_no_AA_eject_choice" style="display:none;">(enregistré)</span></i></td></tr></table>';
