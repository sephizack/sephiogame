...
try {
    ...
    ****************************************/
    ...
    function launch_autospy(current_galaxy, current_system, nb_sondes, scope, options) {
        ...
        _b = colonies_by_systems(colonies_data), tab_systems = _b[0], tab_colonies_by_systems = _b[1], _b, tab_systems = _a[0], tab_colonies_by_systems = _a[1];
...
//# sourceMappingURL=sephiOGame.user.js.map